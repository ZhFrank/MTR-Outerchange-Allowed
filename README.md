...
# Acknowledgements 鸣谢
Thanks to Workbuddy (Tencent) for fixing bugs in the program and setting up Traditional Chinese (Hong Kong/Taiwan) and English translations.
感谢Workbuddy（腾讯）为程序修改bug并配置繁体中文（香港/台湾）和英文翻译。
